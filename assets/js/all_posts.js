...
$(document).ready(function(){
	...
	var elementsToAppendPerScroll = 7; /* Define the elements to index when user reach bottom of the site */

	$.getJSON( "{{site.baseurl | prepend: site.url}}/assets/json/all_posts.json", function(data) {
